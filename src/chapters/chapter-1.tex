...
dikirimkan masih data mentah yang didapatkan langsung dari API Python CARLA,
dan bukan data sensor.
...
simulasi trem otonom. Bab ini akan menjabarkan perangkat lunak, yang digunakan,
misalnya \textit{simulator} CARLA dan ZeroMQ, serta hasil penelitian sebelumnya
yang terkait topik tugas akhir.
