...
Pada sistem yang dibuat, NVDIA Pegasus akan menjadi server yang bertanggung
jawab atas komputasi serta \textit{decision making}. NVIDIA Pegasus yang
digunakan memiliki kumpulan kakas dan pustaka untuk membangun aplikasi robot
yang disebut ROS (\textit{robot operating system}).
...
Rosbridge adalah protokol komunikasi yang menambahkan suatu antarmuka ke ROS.
Antarmuka yang ditambahkan memungkinkan komunikasi dengan \textit{node} ROS
lainnya. Komunikasi dapat dilakukan dengan pola \textit{publish/subscribe} ke
suatu topik ROS. Selain itu, komunikasi dapat dilakukan juga dengan pola
