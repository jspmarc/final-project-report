...
% ROS harus diinstal di atas sistem operasi, seperti Linux, agar dapat digunakan.
% ROS juga dapat dijalankan di atas Docker. Perangkat lunak di ROS diorganisir
% menjadi \textit{packages}. Setiap \textit{packages} dapat terdiri dari
% \textit{node}, pustaka, dan lain-lain.
