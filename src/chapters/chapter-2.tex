...
Rosbridge adalah protokol yang menambahkan antarmuka pada komputer
...
Spesifikasi untuk ROS \textit{bridge} tertuang di proyek \parencite{ros_bridge}.
Untuk lapisan transfer, ROS mendukung WebSocket dan TCP.
