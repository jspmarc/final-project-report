...
%Basic configuration
\title{Pengembangan Mekanisme Komunikasi untuk Simulasi
\textit{Hardware-in-the-loop} Kendaraan Otonom yang Menggunakan CARLA dan NVIDIA
DriveWorks}
\date{23 Juni 2023}
\author{
    Josep Marcello \\
